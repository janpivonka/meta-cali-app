...
import { ExerciseReorderItem } from './components/workout-builder/ExerciseReorderItem';
...
export default function App() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'dashboard':
        return <Dashboard workouts={workouts} onViewHistory={() => setActiveTab('stats')} />;
      case 'explorer':
      ...
      case 'stats':
        return <History workouts={workouts} onMediaClick={handleMediaClick} />;
      case 'ai':
